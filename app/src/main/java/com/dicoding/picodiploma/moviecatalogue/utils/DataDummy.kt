...
object DataDummy {
    ...
    fun generateDummyMovies(): List<MovieEntity> {
        ...
        movies.add(MovieEntity("Mortal Engines",
        ...
        movies.add(MovieEntity("Raya and the Last Dragon",
        ...
        movies.add(MovieEntity("Robin Hood ",
    ...
    fun generateDummyTvShow(): List<TvShowEntity> {
        ...
        tvshow.add(TvShowEntity("Doom Patrol",
        ...
        tvshow.add(TvShowEntity("Gotham",
        ...
        tvshow.add(TvShowEntity("Riverdale",
        "Mystery, Drama, Crime",
        ...
        tvshow.add(TvShowEntity("Shameless",
        "Drama, Comedy",
        ...
        tvshow.add(TvShowEntity("Supergirl",
        ...
        tvshow.add(TvShowEntity("Supernatural",
        ...
        tvshow.add(TvShowEntity("The Umbrella Academy",
        ...
        tvshow.add(TvShowEntity("The Walking Dead",
